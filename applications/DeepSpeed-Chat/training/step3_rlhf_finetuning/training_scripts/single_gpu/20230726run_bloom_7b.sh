...
if [ "$OUTPUT" == "" ]; then
    OUTPUT=/mnt/application/leyf/ds_chat/rlhf_output/20230726__newpara_1ppepoch_add_specialtoken_bloom7b1_from_sft
fi
...
deepspeed  --include "localhost:1,2,3,4,5,6,7" --master_port 29501 main.py \
   ...
   --ppo_epochs 1 --num_train_epochs 1 --actor_learning_rate 1e-6 \
   --critic_learning_rate 1e-6 --actor_weight_decay 0.1 --critic_weight_decay 0.1 \
