...
if [ "$OUTPUT" == "" ]; then
    OUTPUT=/mnt/application/leyf/ds_chat/rlhf_output/20230719_2add_specialtoken_bloom7b1_from_sft_1000samples
fi
...
deepspeed  --include "localhost:1,2,3,4,5,6,7" --master_port 29501 main.py \
   ...
   --output_dir $OUTPUT --data_path /mnt/application/leyf/llm_zoo/mmm/data/rlhf_step3_1000samples \
   --ppo_epochs 5 --num_train_epochs 5 \
